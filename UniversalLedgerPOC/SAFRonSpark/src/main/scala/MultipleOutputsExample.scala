...
////import org.apache.spark.Logging // Added spark.internal logging import below.
...
//  def saveAsNewHadoopMultiOutputs[F <: OutputFormat[_, _]](path: String, conf: Configuration = self.context.hadoopConfiguration)(implicit fm: ClassTag[F]) {
//
